...
/>
            <div className="grid gap-5 md:grid-cols-2">
              <input placeholder="First Name" className="rounded-xl border p-4" />
              <input placeholder="Last Name" className="rounded-xl border p-4" />
            </div>
        ...
        <div className="rounded-2xl bg-white p-8 shadow">
          ...
          <div className="space-y-4">
            <label className="flex cursor-pointer items-center gap-3 rounded-xl border p-4">
              <input type="radio" checked={deliveryMethod==="shipping"} onChange={()=>setDeliveryMethod("shipping")} />
              <div>
                <div className="font-semibold">Ship to my address</div>
                <div className="text-sm text-slate-500">Shipping calculated after your address is entered.</div>
              </div>
            </label>
            ...
            <label className="flex cursor-pointer items-center gap-3 rounded-xl border p-4">
              ...
              <div>
                ...
                <div className="text-sm text-slate-500">Surrey, British Columbia</div>
              </div>
            </label>
          </div>
        </div>
        ...
        {deliveryMethod==="shipping" && (
          <div className="rounded-2xl bg-white p-8 shadow">
            ...
            <div className="grid gap-5">
              <input placeholder="Street Address" className="rounded-xl border p-4" />
              <input placeholder="Apartment / Unit" className="rounded-xl border p-4" />
              <div className="grid gap-5 md:grid-cols-2">
                <input placeholder="City" className="rounded-xl border p-4" />
                <input placeholder="Postal Code" className="rounded-xl border p-4" />
              </div>

              <select value={province} onChange={e=>setProvince(e.target.value as Province)} className="rounded-xl border p-4">
